...
from models import AnalysisRecord, User, StorageCondition
...
from notifications.service import check_and_generate_alerts
...
async def upload_and_analyze(
    ...
    recommendation = (
        food_info["fresh_recommendation"]
        if is_fresh
        else food_info["spoiled_recommendation"]
    )
    ...
    # Automatically create notification for spoiled/near-spoiled food
